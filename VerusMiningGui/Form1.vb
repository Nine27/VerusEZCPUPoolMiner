Public Class Form1
                ...
                While Not reader.EndOfStream
                    ...
                    ElseIf line.Contains("Server") Then
                        ...
                        If result = "usa" Or result = "eu" Then
                            ServerField.Text = "stratum.Verus.nicehash.com:3357"
                        Else
    ...
    Private Sub Form1_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
        If Me.WindowState = FormWindowState.Minimized Then
            ...
            Me.Hide()
            NotifyIcon1.BalloonTipTitle = "Verus Miner GUI"
            NotifyIcon1.BalloonTipText = "Verus Miner GUI running on System Tray"
